...
async function likePost(id) {
    ...
    try {
        const response = await fetch(`/api/api/posts/${id}/like`, {
            method: 'PUT',
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
...
async function submitComment() {
    ...
    try {
        const response = await fetch(`/api/api/posts/${currentCommentId}/comments`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token')}`
...
async function resonancePost(id) {
    ...
    try {
        const response = await fetch(`/api/api/posts/${id}/resonance`, {
            method: 'PUT',
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
